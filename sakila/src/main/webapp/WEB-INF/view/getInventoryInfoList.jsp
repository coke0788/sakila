    ...
    ***********************************-->
    ...
    <div class="btn-group float-right">
        <c:if test="${currentPage > 1}">
            <a href="${pageContext.request.contextPath}/admin/getInventoryInfoList?currentPage=${currentPage-1}&searchWord=${searchWord}"><button class="btn btn-gradient" type="button"><i class="fa fa-angle-left"></i></button></a>
        </c:if>
        <c:if test="${currentPage < lastPage}">
            <a href="${pageContext.request.contextPath}/admin/getInventoryInfoList?currentPage=${currentPage+1}&searchWord=${searchWord}"><button class="btn btn-gradient" type="button"><i class="fa fa-angle-right"></i></button></a>
        </c:if>
    </div>
                                </div>
                            </div>
