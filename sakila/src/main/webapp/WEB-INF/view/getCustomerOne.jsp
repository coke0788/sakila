								...
								<tbody>
									...
									<tr>
										...
										<c:forEach var="r" items="${rentalList}">
											...
											<c:if test="${r!=null}">
												<a class="btn btn-sm btn-light" href="${pageContext.request.contextPath}/admin/getReturn?rentalId=${r.rentalId}&inventoryId=${r.inventoryId}&customerId=${map.customerId}">반납</a>
											</c:if>
											<br>
										</c:forEach>
										</td>
