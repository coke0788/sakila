...
<body>
    <div class="container">
        <h1>addBoard</h1>
        <form id="addForm"
            action="${pageContext.request.contextPath}/addComment" method="post">
            <input type="text" hidden="hidden" name="boardId" id="boardId" value="${boardId}">
            <div class="form-group">
                <label for="commentContent">commentContent :</label>
                <textarea class="form-control" name="commentContent" id="commentContent" rows="5" cols="50"></textarea>
            </div>
            <div class="form-group">
            ...
            <div>
                <input class="btn btn-default" id="addButton" type="button"
                    ...
                    href="${pageContext.request.contextPath}/getBoardOne?boardId=${boardId}">뒤로가기</a>
            </div>
        </form>
    </div>
</body>
